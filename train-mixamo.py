...
parser.add_argument('--save-cpk', type=int, default=100, help='Iterations to save checkpoints [default: 1000]')
...
parser.add_argument('--learning-rate', type=float, default=1e-3, help='Learning rate [default: 1e-5]')
...
#with tf.Session( ) as sess:
    ...
    for i in range(ckpt_number,args.num_iters):
        ...
        print('%s [GEO LOSS] [%10d:]\t%.12f\t%.12f'%( str(args.version), i+1, cd, emd))
